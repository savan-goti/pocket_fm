...
if(isset($_POST['submit'])){
    ...
    if(!empty($id)){
        $data = 'name="'.$name.'",audio="'.$file_name.'",category_id="'.$category_id.'",story_id="'.$story_id.'",updated_time="'.$c_date.'"';
        // $data = "name='".$name."',audio='".$file_name."',category_id='".$category_id."',story_id='".$story_id."'";
        $where = "id=".$id;
        include 'update_data.php';
    }else{
        $column = 'category_id,story_id,name,audio,created_time';
        $data = '"'.$category_id.'","'.$story_id.'","'.$name.'","'.$file_name.'","'.$c_date.'"';
...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
        <h3 class="text-themecolor">Add episode & music</h3>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="episode.php">episode & music</a></li>
            <li class="breadcrumb-item active">Add episode & music</li>
        </ol>
    </div>
