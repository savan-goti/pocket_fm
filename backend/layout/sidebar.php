...
<aside class="left-sidebar">
    ...
    <div class="scroll-sidebar">
        ...
        <div class="user-profile" style="background: url(<?= $base_url; ?>assets/images/background/user-info.jpg) no-repeat;">
            <!-- User profile image -->
            <div class="profile-img"> <img src="<?= $base_url; ?>assets/images/users/sidebar.png" alt="user" /> </div>
            <!-- User profile text-->
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li>
                    <a class="" href="storys_type.php"><i class="ti-layers-alt"></i><span>Story Type </span></a>
                </li>
                <li>
