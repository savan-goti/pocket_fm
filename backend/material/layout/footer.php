<!-- Row -->
    ...
    <script src="<?= $base_url; ?>material/js/jquery.slimscroll.js"></script>
    <!--Wave Effects -->
    <script src="<?= $base_url; ?>material/js/waves.js"></script>
    <!--Menu sidebar -->
    <script src="<?= $base_url; ?>material/js/sidebarmenu.js"></script>
    <!--stickey kit -->
    <script src="<?= $base_url; ?>assets/plugins/sticky-kit-master/dist/sticky-kit.min.js"></script>
    <script src="<?= $base_url; ?>assets/plugins/sparkline/jquery.sparkline.min.js"></script>
    <!--Custom JavaScript -->
    <script src="<?= $base_url; ?>material/js/custom.min.js"></script>
    <!-- chartist chart -->
    ...
    <script src="<?= $base_url; ?>material/js/dashboard2.js"></script>
    <!-- This is data table -->
    <script src="<?= $base_url; ?>assets/plugins/datatables/datatables.min.js"></script>
    <!-- start - This is for export functionality only -->
    <script src="<?= $base_url; ?>assets/export/dataTables.buttons.min.js"></script>
    <script src="<?= $base_url; ?>assets/export/buttons.flash.min.js"></script>
    ...
    <script src="<?= $base_url; ?>material/js/validation.js"></script>
    <script>
