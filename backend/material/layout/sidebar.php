    ...
    <div class="scroll-sidebar">
        ...
        <div class="user-profile" style="background: url(<?= $base_url; ?>assets/images/background/user-info.jpg) no-repeat;">
            ...
            <div class="profile-text"> <a href="#" class="dropdown-toggle u-dropdown" data-toggle="dropdown"
                ...
                <div class="dropdown-menu animated flipInY">
                    ...
                    <div class="dropdown-divider"></div> <a href="setting.php" class="dropdown-item"><i
                            class="ti-settings"></i> Account Setting</a>
                    <div class="dropdown-divider"></div> <a href="logout.php" class="dropdown-item"><i
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li>
                    <a class="" href="storys.php"><i class="mdi mdi-gauge"></i><span>Storys </span></a>
                </li>
                <li>
                    <a class="" href="episode.php"><i class="mdi mdi-gauge"></i><span>All Episodes </span></a>
                </li>
                <!-- <li>
